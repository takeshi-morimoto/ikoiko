...
<head>
    ...
    <style>
        :root {
            ...
            --text-light: #7F8C8D;
            --bg-light: #F8F9FA;
            --color-anime-primary: #4A90E2;
            --color-anime-secondary: #E3F2FD;
            --color-machi-primary: #FF6B6B;
            --color-machi-secondary: #FFE0E0;
        }
        ...
        .page-header.anime-header {
            background: linear-gradient(135deg, #0575E6 0%, #21D4FD 100%) !important;
            position: relative;
            overflow: hidden;
        }
        
        .page-header.anime-header::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .page-header.machi-header {
            background: linear-gradient(135deg, #FA709A 0%, #FEE140 100%) !important;
            position: relative;
            overflow: hidden;
        }
        
        .page-header.machi-header::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* CTAセクションのグラデーション */  
        .cta-section.anime-cta {
            background: linear-gradient(135deg, #0575E6 0%, #21D4FD 100%) !important;
            position: relative;
            overflow: hidden;
        }
        
        .cta-section.anime-cta::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .cta-section.machi-cta {
            background: linear-gradient(135deg, #FA709A 0%, #FEE140 100%) !important;
            position: relative;
            overflow: hidden;
        }
        
        .cta-section.machi-cta::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .theme-anime .navbar-nav .nav-link.active {
            color: var(--color-anime-primary) !important;
        }
        
        .theme-anime .navbar-nav .nav-link.active::after {
            background: var(--color-anime-primary) !important;
        }
        
        .theme-machi .btn-primary,
        .theme-machi .navbar-nav .nav-link.active {
            color: var(--color-machi-primary) !important;
        }
        
        .theme-machi .navbar-nav .nav-link.active::after {
            background: var(--color-machi-primary) !important;
        }
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->get('category') === 'anime' || request()->routeIs('anime.*') ? 'active' : '' }}" 
                               href="{{ route('anime.index') }}">
                                <i class="fas fa-star me-1" style="color: #0575E6;"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->get('category') === 'machi' || request()->routeIs('machi.*') ? 'active' : '' }}" 
                               href="{{ route('machi.index') }}">
                                <i class="fas fa-city me-1" style="color: #FA709A;"></i>
