...
<head>
	...
	$canonical_url = "https://koikoi.co.jp/ikoiko/list_4.php";
...
<div id="pageTop">
	...
	<h1 id="catch" style="background-color:#0ACEFF;">婚活・恋活・友活ならこいこい街コン</h1>
		...
		<div id="mainContent">
			...
			<div id="searchResult" class="card">
			    ...
			    $result = $db->query("
			                  ...
			                  where {$where_1} {$where_2} and area.page = 'off' 
			    ...
			    while ( $row = $result->fetch() ):
			      ...
			      <div class='event'>
			            ...
			            <img class='eventImg' src='https://koikoi.co.jp/ikoiko/img/img_thamb/{$find}' alt='{$area_ja}の{$name}' loading='lazy' />
