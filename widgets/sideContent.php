...
<body>
    ...
    <!--<div class="banner" style="padding: 0 20px;">
        <p class="sidebarstyle">
            ...
            <b>■神社アニメコン in 東京/中野沼袋氷川神社<br>御祈祷、お守り、絵馬付き！<br>
                5月20日(土) 9:45～12:00<br>
                6月17日(土) 9:45～12:00<br>
                <a href="https://koikoi.co.jp/ikoiko/event/a_tokyo_hikawashrine_hiru">お申し込みはこちら！</a><br><br></b>
        </p>
    </div> -->
    ...
    <!-- メルマガ登録フォーム -->
    <div class="banner" style="padding: 0 20px 10px" align="center">
