...
<body>
    ...
    <div class="banner" style="padding: 10px 20px;">
        <a href="//koikoi.co.jp/ikoiko/">
            <img src="/ikoiko/img/sidebar/160124animesearch_300x100.jpg" alt="アニメコンを探す" title="アニメコンを探す">
        </a>
    </div>
    ...
    <!--<div class="banner" style="padding: 0 20px 10px;">
        <a href="/ikoiko/yoruuuu/">
            <img src="/ikoiko/img/sidebar/moterufashion.jpg" alt="yoruuuu" title="yoruuuu" width="100%">
        </a>
    </div>-->

    <!-- アルバイトスタッフ募集バナー -->
    <div>
        <a href="//koikoi.co.jp/ikoiko/スタッフ募集_m.php">
            <img src="/ikoiko/img/sidebar/151216parttimejob_300x100.jpg" alt="アルバイトスタッフ募集" title="アルバイトスタッフ募集">
        </a>
    </div>
